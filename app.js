(() => {
  ...
  const setStage = (stage, message = "") => {
    ...
    const introIsActive = stage === "start" || stage === "reveal" || stage === "morph";
    const videoIsActive = stage === "video";
    const finalIsActive = stage === "final";

    introScene.inert = !introIsActive;
    videoScene.inert = !videoIsActive;
    finalScene.inert = !finalIsActive;
    introScene.setAttribute("aria-hidden", String(!introIsActive));
    videoScene.setAttribute("aria-hidden", String(!videoIsActive));
    finalScene.setAttribute("aria-hidden", String(!finalIsActive));
